...
Скриншоты
(Добавьте скриншоты согласно требованиям задания)

Примечания
Все ВМ создаются как прерываемые для экономии средств

Использована версия Terraform ~> 1.12.0

Код написан без хардкода значений

После выполнения все ресурсы уничтожены
